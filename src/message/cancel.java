...
public class cancel {
  ...
  try {
      ...
      if(args.length<3){
         System.out.println("Use: java cancel id passwd messageid");
         System.out.println(" Ex: java cancel test test123 A2967053126752930574");
         return;
      }
      ...
      ret_code=mysms.cancel_text_message(messageid);
      if( ret_code == 0 ) {
           System.out.println("²�T�w����!");
           System.out.println("MessageID="+mysms.get_message()); //���oMessageID
      } else {
           System.out.println("²�T�ثe�D�w�����A!");
