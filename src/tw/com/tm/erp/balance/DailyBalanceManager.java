...
public class DailyBalanceManager {
    ...
    private static final Log log = LogFactory.getLog(DailyBalanceManager.class);
    ...
    public void performAction(String brandCode, String opUser, Date startDate, Date endDate) {
    	log.info("startDateendDate"+startDate+"endDate111"+endDate);
	...
	if(null==startDate && null==endDate){
		...
		startDate = DateUtils.addDays(ExecloseDate, -1);
		endDate = DateUtils.addDays(ExecloseDate, -1);
	}
	try {
		log.info("startDate222"+startDate+"endDate22222222"+endDate);
	    ...
	    System.out.println("品牌:"+brandCode);
	    ...
	    if(brandCodeArray != null && brandCodeArray.length > 0){
	        ...
	        if (errorMsgs.size() > 0) {
	        	log.info("ERROR:"+errorMsgs.toString());
	    	...
	    	if(errorMsgs.size() == 0){
	    		log.info("無錯誤");
	    		log.info("ERROR:"+errorMsgs.toString());
	    		updateDailyBalanceDate(brandCode, startDate, "SYSTEM");
     ...
     * @param opUser
     */
    public String performAction1(String brandCode, String opUser, Date startDate, Date endDate) {
    	log.info("startDateendDate"+startDate+"endDate111"+endDate);
	String returnMessage = null;
	String message = null;
	String performResult = MessageStatus.SUCCESS;
