...
public class ImMovementImportDataT2cwMain implements ImportDataAbs {
	private static final Log log = LogFactory.getLog(ImMovementImportDataT2cwMain.class);
	...
	public ImportInfo initial(HashMap uiProperties) {
		log.info("<<<< ImMovementImportDataT2cwMain initial >>>>");
	...
	public String updateDB(List entityBeans, ImportInfo info) throws Exception {
		...
		try {
			...
			String[] wff = {"J01","JT1","JC1"};//wff,wfp只能出現
			String[] wgf = {"J02","J03","JT2","JT3","JE2","JE3","JS2","JS3","JC2","JC3","JE2","JE3",
							"JM2","JM3","JB2","JB3","JD2","JD3","JK2","JK3"};//wgf,wgp中只能出現
			//------
