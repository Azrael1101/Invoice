...
public class ImRecieveImportDataT2M implements ImportDataAbs {
	private static final Log log = LogFactory.getLog(ImRecieveImportDataT2M.class);
	...
	public ImportInfo initial(HashMap uiProperties) {
		...
		imInfo.addFieldName("e");
		imInfo.addFieldName("f");
		imInfo.addFieldName("g");
		...
		imInfo.setFieldType("e", "java.lang.String");
		imInfo.setFieldType("f", "java.lang.String");
		imInfo.setFieldType("g", "java.lang.String");
		imInfo.addFieldName("orderTypeCode");
		imInfo.addFieldName("orderNo");
