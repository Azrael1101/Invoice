...
import tw.com.tm.erp.hbm.bean.SoDeliveryHead;
 ...
 public class BuPurchaseHeadDAO extends BaseDAO {
	...
	public BuPurchaseHead findById(Long id) {
		log.debug("getting BuPurchaseHead instance with id: " + id);
		try {
			BuPurchaseHead instance = (BuPurchaseHead) getHibernateTemplate().get(
					"tw.com.tm.erp.hbm.bean.BuPurchaseHead", id);
			return instance;
