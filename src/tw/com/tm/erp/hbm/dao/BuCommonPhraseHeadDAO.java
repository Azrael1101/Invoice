...
public class BuCommonPhraseHeadDAO  extends BaseDAO {
	private static final Log log = LogFactory
			.getLog(BuCommonPhraseHeadDAO.class);
	// property constants
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding BuCommonPhraseHead instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from BuCommonPhraseHead as model where model."
					+ propertyName + "= ?";
	...
	public static BuCommonPhraseHeadDAO getFromApplicationContext(
			ApplicationContext ctx) {
		return (BuCommonPhraseHeadDAO) ctx.getBean("buCommonPhraseHeadDAO");
	}
