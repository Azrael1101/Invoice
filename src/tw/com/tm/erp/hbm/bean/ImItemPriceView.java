...
/**
 * ImItemPriceViewId entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class ImItemPriceView implements java.io.Serializable {

	// Fields

	private static final long serialVersionUID = 6028184897627013102L;
	...
	private Double purchaseAmount;			// 進貨價格 david 20100105 
	...
	private String priceEnableName;	// 非db欄位, 顯示價格啟用中文
	
	// Constructors

	/** default constructor */
	public ImItemPriceView() {
	}

	/** minimal constructor */
	public ImItemPriceView(Long priceId,  String itemCode,
			String brandCode) {
	...
	/** full constructor */
	public ImItemPriceView(Long priceId, String itemCode, String brandCode,
			...
			Double salesRatio, String purchaseUnit, String description,
			Long priceAdjustId, String typeCode, String salesUnit,
			String currencyCode, Double unitPrice, String isTax, String taxCode,
			Date beginDate, String priceEnable, String createdBy,
			Date creationDate, String lastUpdatedBy, Date lastUpdateDate,
			String itemEnable, String specLength, String specWidth,
			String specHeight, String specWeight, String category01,
	...
	public String getPriceEnableName() {
		return priceEnableName;
	}

	public void setPriceEnableName(String priceEnableName) {
		this.priceEnableName = priceEnableName;
	}
