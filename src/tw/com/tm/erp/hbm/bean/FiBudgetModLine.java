...
public class FiBudgetModLine implements java.io.Serializable {
	...
	private Long lineId;
	private FiBudgetModHead fiBudgetModHead;
	private Long month;
	...
	private Double budgetAdjustAmount;
	...
	private Double forecastAdjustAmount;
    private String itemBrandName;
	// Constructors

	/** default constructor */
	public FiBudgetModLine() {
	}
	...
	/** minimal constructor */
	public FiBudgetModLine(Long lineId) {
		this.lineId = lineId;
	}
	...
	public FiBudgetModHead getFiBudgetModHead() {
		return this.fiBudgetModHead;
	}

	public void setFiBudgetModHead(FiBudgetModHead fiBudgetModHead) {
		this.fiBudgetModHead = fiBudgetModHead;
	}
	...
	public Double getBudgetAdjustAmount() {
		return budgetAdjustAmount;
	}

	public void setBudgetAdjustAmount(Double budgetAdjustAmount) {
		this.budgetAdjustAmount = budgetAdjustAmount;
	}
	...
	public Double getForecastAdjustAmount() {
		return forecastAdjustAmount;
	}

	public void setForecastAdjustAmount(Double forecastAdjustAmount) {
		this.forecastAdjustAmount = forecastAdjustAmount;
	}
