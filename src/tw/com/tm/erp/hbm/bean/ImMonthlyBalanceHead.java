...
public class ImMonthlyBalanceHead implements java.io.Serializable {
	...
	private ImMonthlyBalanceHeadId id;
	...
	private Set imMonthlyBalanceLines = new HashSet(0);
	private int indexNo;
	...
	/** default constructor */
	public ImMonthlyBalanceHead() {
	}

	/** minimal constructor */
	public ImMonthlyBalanceHead(ImMonthlyBalanceHeadId id) {
		this.id = id;
	}
	...
	public ImMonthlyBalanceHead(ImMonthlyBalanceHeadId id,
			...
			Date updateDate, Set imMonthlyBalanceLines, String taxType,
		...
		this.imMonthlyBalanceLines = imMonthlyBalanceLines;
	}

	// Property accessors

	public ImMonthlyBalanceHeadId getId() {
		return this.id;
	}

	public void setId(ImMonthlyBalanceHeadId id) {
		this.id = id;
	}
	...
	public Set<ImMonthlyBalanceLine> getImMonthlyBalanceLines() {
		return this.imMonthlyBalanceLines;
	}

	public void setImMonthlyBalanceLines(Set<ImMonthlyBalanceLine> imMonthlyBalanceLines) {
		this.imMonthlyBalanceLines = imMonthlyBalanceLines;
	}
	...
	public void setAdjustQuantity(Double periodAdjustCostQuantity, Double periodAdjustmentQuantity){
		this.adjustQuantity = periodAdjustCostQuantity + periodAdjustmentQuantity;
	}
