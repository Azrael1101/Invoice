...
/**
 * ImItemDiscountModLine entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class ImItemDiscountModLine implements java.io.Serializable {

	// Fields

	private Long lineId;
	private ImItemDiscountModHead imItemDiscountModHead;
	...
	/** default constructor */
	public ImItemDiscountModLine() {
	}

	/** minimal constructor */
	public ImItemDiscountModLine(Long lineId) {
		this.lineId = lineId;
	}

	/** full constructor */
	public ImItemDiscountModLine(Long lineId, Long headId, String brandCode,
	...
	public ImItemDiscountModHead getImItemDiscountModHead() {
	...
	public void setImItemDiscountModHead(ImItemDiscountModHead imItemDiscountModHead) {
		this.imItemDiscountModHead = imItemDiscountModHead;
	}
