...
/**
 * ImItemDiscount entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class ImItemDiscount implements java.io.Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = 8077758056203551139L;
    // Fields
    private ImItemDiscountId id;
    ...
    /** default constructor */
    public ImItemDiscount() {
    }

    /** full constructor */
    public ImItemDiscount(String brandCode, String vipTypeCode, String itemDiscountType, 
	    ...
	    Date lastUpdateDate, String lastUpdatedByName) {
    ...
    public ImItemDiscountId getId() {
    	return this.id;
    }

    public void setId(ImItemDiscountId id) {
    	this.id = id;
    }
    /*  
