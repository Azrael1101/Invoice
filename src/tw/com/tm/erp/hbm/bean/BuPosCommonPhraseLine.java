...
public class BuPosCommonPhraseLine implements java.io.Serializable {
	...
	/** default constructor */
	public BuPosCommonPhraseLine() {
	}

	/** minimal constructor */
	public BuPosCommonPhraseLine(BuCommonPhraseLineId id) {
		this.id = id;
	}

	/** full constructor */
	public BuPosCommonPhraseLine(BuCommonPhraseLineId id, String name,
