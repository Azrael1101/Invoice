...
/**
 * ImPromotionFile entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class ImPromotionFile implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1438956431651428976L;
	private Long lineId;
	...
	/** default constructor */
	public ImPromotionFile() {
	}

	/** minimal constructor */
	public ImPromotionFile(Long lineId) {
		this.lineId = lineId;
	}

	/** full constructor */
	public ImPromotionFile(Long lineId, ImPromotion imPromotion, Long fileId,
			...
			String reserve5, String createdBy,
