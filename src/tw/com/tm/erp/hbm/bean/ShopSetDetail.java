...
public class ShopSetDetail implements java.io.Serializable {
	...
	/** default constructor */
	public ShopSetDetail() {
		
	}

	/** full constructor */
	public ShopSetDetail(Long indexNo, Long lineId ,String brandCode, String url,
			String enable,String brandName, String categoryCode, String categoryName, String type
			) {
