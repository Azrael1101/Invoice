...
public class SiGroupMenuCtrl implements java.io.Serializable {

	// Fields

	private static final long serialVersionUID = -4963494596263023286L;
	private SiGroupMenuIdCtrl id;
	...
	/** default constructor */
	public SiGroupMenuCtrl() {
	}

	/** minimal constructor */
	public SiGroupMenuCtrl(SiGroupMenuIdCtrl id, SiGroup siGroup) {
		this.id = id;
		this.siGroup = siGroup;
	}

	/** full constructor */
	public SiGroupMenuCtrl(SiGroupMenuIdCtrl id, SiGroup siGroup, String functionCode,
	...
	public SiGroupMenuIdCtrl getId() {
		return this.id;
	}

	public void setId(SiGroupMenuIdCtrl id) {
		this.id = id;
	}
