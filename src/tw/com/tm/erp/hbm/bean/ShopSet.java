...
public class ShopSet implements java.io.Serializable {
	...
	private List<ShopSetDetail> shopSetDetails = new ArrayList(0);
	...
	/** full constructor */
	public ShopSet( String orderTypeCode,String orderNo, String brandCode, String request,
	...
	public List<ShopSetDetail> getShopSetDetails() {
		return shopSetDetails;
	}

	public void setShopSetDetails(List<ShopSetDetail> shopSetDetails) {
		this.shopSetDetails = shopSetDetails;
	}
