...
public class ImStorageOnHandView implements java.io.Serializable {

	// Fields

	private static final long serialVersionUID = 5722210655309197538L;
	private ImStorageOnHandViewId id;
	...
	/** default constructor */
	public ImStorageOnHandView() {
	}

	/** full constructor */
	public ImStorageOnHandView(ImStorageOnHandViewId id) {
		this.id = id;
	}

	public ImStorageOnHandViewId getId() {
		return this.id;
	}

	public void setId(ImStorageOnHandViewId id) {
		this.id = id;
	}
