...
public class ImDistributionShop implements java.io.Serializable {

	// Fields

	private static final long serialVersionUID = 880478234140458026L;
	public static final String TABLE_NAME = "ERP.IM_DISTRIBUTION_SHOP" ;
	...
	/** default constructor */
	public ImDistributionShop() {
	}

	/** minimal constructor */
	public ImDistributionShop(Long lineId) {
		this.lineId = lineId;
	}
