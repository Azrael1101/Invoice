 ...
 * 
 */
public class PoPurchaseOrderLineService {
	private static final Log log = LogFactory.getLog(PoPurchaseOrderLineService.class);
	...
	public String create(PoPurchaseOrderLine modifyObj) {
		log.info("PoPurchaseOrderLineService.doValidate");
		if (null != modifyObj) {
	...
	public String save(PoPurchaseOrderLine saveObj) {
		log.info("PoPurchaseOrderLineService.save");
	...
	public String update(PoPurchaseOrderLine updateObj) {
		log.info("PoPurchaseOrderLineService.update");
	...
	public PoPurchaseOrderLine findById(Long headId) {
		log.info("PoPurchaseOrderLineService.PoPurchaseOrderLine");
	...
	public void setLastUnitCost(PoPurchaseOrderLine lineObj) {
		if (null != lineObj) {
			log.info("PoPurchaseOrderLineService.setLastUnitCost lineObj.getLastForeignUnitCost()=" + lineObj.getLastForeignUnitCost());
	...
	public void setOriginalUnitPrice(PoPurchaseOrderHead headObj, PoPurchaseOrderLine lineObj) {
		log.info("PoPurchaseOrderLineService.setOriginalUnitPrice");
	...
	public String getOriginalUnitPrice(String brandCode, String orderTypeCode, String itemCode) throws FormException {
		log.info("PoPurchaseOrderLineService.getOriginalUnitPrice BrandCode=" + brandCode + ",OrderTypeCode=" + orderTypeCode);
	...
	public String getLastUnitCost(String itemCode) {
		log.info("PoPurchaseOrderLineService.setLastUnitCost itemCode=" + itemCode);
		Double foreignUnitPrice = new Double(0);
		if (StringUtils.hasText(itemCode)) {
	...
	public List<PoPurchaseOrderLine> findPageLine(Long headId, int startPage, int pageSize) {
		log.info("PoPurchaseOrderLineService.findPageLine headId=" + headId + "startPage=" + startPage + "pageSize" + pageSize);
	...
	public PoPurchaseOrderLine findLine(String headId, String lineId) {
		log.info("PoPurchaseOrderLineService.setLastUnitCost headId=" + headId + ",lineId=" + lineId);
	...
	public PoPurchaseOrderLine findLine(Long headId, Long lineId) {
		log.info("PoPurchaseOrderLineService.findLine headId=" + headId + ",lineId=" + lineId);
