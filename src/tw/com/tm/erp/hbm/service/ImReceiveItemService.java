 ...
 */
public class ImReceiveItemService {
	private static final Log log = LogFactory.getLog(ImReceiveItemService.class);
	...
	public void doValidate(ImReceiveHead head, ImReceiveItem item) throws FormException {
		log.info("ImReceiveItemService.doValidate");
	...
	public List<ImReceiveItem> findPageLine(Long headId, int startPage, int pageSize) {
		log.info("ImReceiveItemService.findPageLine headId=" + headId + "startPage=" + startPage + "pageSize" + pageSize);
	...
	public ImReceiveItem findLine(String headId, String lineId) {
		log.info("ImReceiveItemService.findLine headId=" + headId + ",lineId=" + lineId);
	...
	public Long findPageLineMaxIndex(Long headId) {
		log.info("ImReceiveItemService.findPageLineMaxIndex");
