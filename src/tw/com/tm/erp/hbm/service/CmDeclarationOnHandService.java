...
public class CmDeclarationOnHandService {

	private static final Log log = LogFactory.getLog(CmDeclarationOnHandService.class);
...
//			"declDate", "importDate", "warehouseInDate", "customsItemCode", "currentOnHandQty", "originalDate", "qty",
//			"remainDays", "expiryDate", "itemCName", "unitPrice", "categoryType", "category01", "category01Name",
//			"category02", "category02Name", "category03", "itemBrand", "itemBrandName", "supplierCode", "supplierName" };

	// 展延功能 修改庫存進倉屆期邏輯後，importDate 與 originalDate 功能改變互換  Daniel
	public static final String[] GRID_SEARCH_FIELD_NAMES = { "customsWarehouseCode", "declarationNo", "declarationSeq",
		"isExtention" ,"declDate",  "warehouseInDate",  "orDeclDate", "expiryDate", "customsItemCode", "currentOnHandQty", "qty",
		"remainDays", "itemCName", "unitPrice", "categoryType", "category01", "category01Name",
		"category02", "category02Name", "category03", "itemBrand", "itemBrandName", "supplierCode", "supplierName" };
	...
	public List<Properties> executeSearchInitial(Map parameterMap) throws Exception {
		...
		try {
			...
			try{
				customsWarehouseCode = (String) PropertyUtils.getProperty(otherBean, "customsWarehouseCode");
...
//					if (StringUtils.hasText(cmDeclarationOnHandView.getIsExtention()) ){
//						if(cmDeclarationOnHandView.getDeclType().equals("D7")){
//							log.info("D7");
//							cmDeclarationOnHandView.setOriginalDate(cmDeclarationOnHandView.getOrDeclDate());
//							}else{
//							log.info("D8");
//							cmDeclarationOnHandView.setOriginalDate(cmDeclarationOnHandView.getOrgImportDate());
//						}
//					}
					
					// 原D8日期(展延前) 欄位判斷  Daniel
					if ( !cmDeclarationOnHandView.getDeclType().equals("D7") ){
						if( cmDeclarationOnHandView.getOrgImportDate() != null ){
							cmDeclarationOnHandView.setOrDeclDate(cmDeclarationOnHandView.getOrgImportDate());
						}else{
							cmDeclarationOnHandView.setOrDeclDate(cmDeclarationOnHandView.getImportDate());
						}
					}
					
					log.info("OrDeclDate = " +cmDeclarationOnHandView.getOrDeclDate());
