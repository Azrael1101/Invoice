 ...
 * </p>
 * <p>
 * Description: Used to indicate a fatal error, while writing or reading a
 * database (DBF) file.
 * </p>
 * <p>
 ...
 * </p>
 * 
 * @author Bart Jourquin, adapted from original free lib by SV Consulting
 *         (http://www.svcon.com/)
 * @version 1.0
 */
public class JDBFException extends Exception {
	...
	/**
	 * Constructs a nested JDBFException, containing another exception and a
	 * specific message.
	 * 
	 * @param s
	 *            String
