	...
	if(typeof document.forms[0]["#loginBrandCode"] != 'undefined'){
        ...
        { 
          ...
          loginEmployeeCode  	: document.forms[0]["#loginEmployeeCode" ].value
	   	...
	   	vat.bean.init(	
	  		function(){
					return "process_object_name=dailyCloseMainManager&process_object_method_name=executeCmInitial"; 
	    	},{
	    		other: true
	    	}
	    );
...
function headerInitial(){ 
	vat.block.create( vnB_Header, {
		...
		rows:[
			...
			{row_style:"", cols:[
				{items:[{name:"#L.cmDate", type:"LABEL", value:"海關關帳日期<font color='red'>*</font>"}]},
				{items:[{name:"#F.cmDate", type:"DATE", bind:"cmDate"}]}
			]}
		],
		beginService:"",
		closeService:""			
...
function showMessage(){
	...
	var returnData = window.open(
		...
		"?programId=DAILY_CLOSE_MAIN_MANAGER_CM" +
		"&levelType=ERROR" +
