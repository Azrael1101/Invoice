   ...
   if(typeof document.forms[0]["#loginBrandCode"] != 'undefined'){
  	...
  	vat.bean().vatBeanOther =
  	    {loginBrandCode     : document.forms[0]["#loginBrandCode"    ].value,
  	     ...
  	     orderTypeCode      : vat.item.getValueByName("#F.orderTypeCode") == "" ? "DZM":vat.item.getValueByName("#F.orderTypeCode"),
	 ...
	 {row_style:"", cols:[
	 	{items:[
	 			...
	 			{name:"#B.search"      , type:"PICKER" , value:"查詢",  src:"./images/button_find.gif"  ,
	 									 openMode:"open",
	 									 service:"So_Delivery:searchMove:20101213.page",
...
function searchDelivery(triggeredBy){
	...
	if(vsAllow){
		vat.block.pageDataSave(vnB_Detail,{
			funcSuccess:function(){
		  		vat.bean().vatBeanOther.brandCode = vat.item.getValueByName("#F.brandCode");
		  		//vat.bean().vatBeanOther.orderTypeCode = "DZN";
