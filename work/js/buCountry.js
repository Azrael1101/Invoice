...
function headerInitial(){ 
	vat.block.create( vnB_Header, { //vnB_Header = 
		...
		rows:[
			{row_style:"", cols:[
				{items:[{name:"#L.countryCode", type:"LABEL", value:"國別代碼<font color='red'>*</font>" }]},
				{items:[{name:"#F.countryCode", type:"TEXT", bind:"countryCode", size:2, maxLen:2 }]},
				{items:[{name:"#F.enable", type:"CHECKBOX",  bind:"enable" },
						{name:"#L.enable", type:"LABEL",value:"停用?", size:10 }],td:" colSpan=2"}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.countryCName", type:"LABEL", value:"中文名稱<font color='red'>*</font>"}]},
				{items:[{name:"#F.countryCName", type:"TEXT", bind:"countryCName", size:25, maxLen:25 }]},
				{items:[{name:"#L.description", type:"LABEL", value:"說明", row:2, col: 40}], td:" rowSpan=2"},
				{items:[{name:"#F.description", type:"TEXTAREA", bind:"description", size:50 , row:2, col: 50}], td:" rowSpan=2"}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.countryEName", type:"LABEL" , value:"英文名稱<font color='red'>*</font>"}]},
				{items:[{name:"#F.countryEName", type:"TEXT", bind:"countryEName", size:25, maxLen:25 }]}
			]},
			{row_style:"", cols:[
...
function doSubmit(formAction){
	...
	if(confirm(alertMessage)){
		...
		vat.block.submit(function(){
				...
				"&process_object_method_name=performBuCountryTransaction";
			},{
