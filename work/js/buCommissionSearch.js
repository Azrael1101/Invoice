		...
		title:"佣金類別查詢作業", rows:[  
	 		{row_style:"", cols:[
				...
				{items:[{name:"#F.commissionType",	type:"TEXT", bind:"commissionType", size:20}]},
			 	{items:[{name:"#L.category02", 	type:"LABEL", 	value:"類別代號"}]},
...
function detailInitial(){
  ...
  var vbCanGridModify = true;
	...
	vat.item.make(vnB_Detail, "category02"  	, {type:"TEXT" , size:18, maxLen:20, mode:"READONLY", desc:"類別"      });
	...
	vat.item.make(vnB_Detail, "typeId"      	, {type:"ROWID"});
...
function loadBeforeAjxService(){
   // alert("loadBeforeAjxService");	
	...
	var processString = "process_object_name=buGoalCommissionService&process_object_method_name=getAJAXSearchPageData" + 
