	...
	if(typeof document.forms[0]["#loginBrandCode"] != 'undefined'){
        ...
        { 
          ...
          formId             	: document.forms[0]["#formId"            ].value
	   	...
	   	vat.bean.init(	
	  		function(){
					return "process_object_name=monthlyBalanceMainManager&process_object_method_name=executeInitial"; 
	    	},{
	    		other: true
	    	}
	    );
		...
		vat.block.create( vnB_Header, {
			...
			rows:[
				...
				{row_style:"", cols:[
					...
					{items:[{name:"#F.monthlyBalanceYear", type:"SELECT", bind:"monthlyBalanceYear", init:years},
							{name:"#L.monthlyBalanceYear", type:"LABEL", value:"年"},
							{name:"#F.monthlyBalanceMonth", type:"SELECT", bind:"monthlyBalanceMonth", init:months},
							{name:"#L.monthlyBalanceMonth", type:"LABEL", value:"月"}]}
				]},
				{row_style:"", cols:[
					{items:[{name:"#L.mode", type:"LABEL", value:"是否進行正式執行" }]},
...
function showMessage(){
	...
	var returnData = window.open(
		...
		"?programId=MONTHLY_BALANCE_MAIN_MANAGER" +
		"&levelType=ERROR" +
