...
function headerInitial(){
	...
	var allOrderTypes   = [[false, false,false,false,false,false], ["IRQ-需求單","PRC-請採驗","OSP-開店工程","BPR-新人","TAS-任務","LOA-權限","CSF-客服","WOA-庫別"], ["IRQ","PRC","OSP","BPR","TAS","LOA","CSF","WOA"]];
...
function loadBeforeAjxService(){
   //alert("載入之前:"+document.forms[0]["#loginBrandCode" ].value);	
	...
	var processString = "process_object_name=buPurchaseService&process_object_method_name=getAJAXBuGoalAchevementSearchPageData" + 
	                  	"&brandCode"       + "=" + document.forms[0]["#loginBrandCode" ].value +
