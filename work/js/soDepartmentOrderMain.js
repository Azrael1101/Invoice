...
//	detailInitial();
   ...
   //--------------------------detail
 	...
 	document.write('<tr height="10%">');
   		document.write('<td colspan="0" width="60%">');
		...
		document.write('</td>');
			...
			/*功能鍵*/
		document.write('<td colspan="0" valign="top">');
		document.write('<table border="0" width="40%">');
//功能頁籤
	  		document.write('<tr>');
	  			document.write('<td >');
					buttonLineTag();
...
//主功能面板
				document.write('<td>');
					document.write('<div id = "menu01" style="display:none;">');
						//buttonLine();
						totalInitial();
					document.write('</div>');
//主功能面板2
...
function initParm(){
	...
	if(queryString.indexOf('?')!=-1){
		if(queryString.indexOf('appCodePre')!=-1){
			appCodePre = queryString.substring(queryString.indexOf('appCodePre')+11);
			vat.item.setValueByName("#F.appCode" , appCodePre);
		}
	}
};
	...
	rows:[
			{row_style:"", cols:[
				...
				{items:[{name:"#F.shopCode", 						type:"TEXT",  mode:"READONLY" ,	bind:"shopCode" },
						...
						{name:"#F.formId",				type:"TEXT",  mode:"HIDDEN", 	bind:"headId" },
						{name:"#F.salesoOrderId",				type:"TEXT",  mode:"HIDDEN", 	bind:"salesoOrderId" }]},
				{items:[{name:"#L.posMachineCode", 					type:"LABEL" , 	value:"機號"}]},
				{items:[{name:"#F.posMachineCode", 					type:"TEXT",  mode:"READONLY" ,	bind:"posMachineCode" }]},
			...
			{row_style:"", cols:[
				{items:[{name:"#L.guiCode", 				type:"LABEL" , 	value:"發票號碼"}]},
				{items:[{name:"#F.guiCode", 				type:"TEXT",  mode:"READONLY", 	bind:"guiCode" },
				...
				{items:[{name:"#L.reserve1", 					type:"LABEL" , 	value:"統編"}]},
				{items:[{name:"#F.reserve1",		 			type:"TEXT",  mode:"READONLY" ,	bind:"reserve1" }]},
				{items:[{name:"#L.customerPoNo", 			type:"LABEL" , 	value:"交易序號"}]},
				{items:[{name:"#F.customerPoNo", 			type:"TEXT",  mode:"READONLY" ,	bind:"customerPoNo"},
						{name:"#F.salesEmployeeName",	 		type:"TEXT" , mode:"READONLY"}
				]},
				{items:[{name:"#L.remark1", 				type:"LABEL" , 	value:"滿額贈代碼"}]},
			...
			{row_style:"", cols:[
				...
				{items:[{name:"#F.appCode", 				type:"TEXT",  	bind:"appCode" }]},
				{items:[{name:"#L.remark1", 				type:"LABEL" , 	value:"VIP代號"}]},
				{items:[{name:"#F.remark1",				type:"TEXT", 	bind:"remark1", 				size:25, maxLen:25 }],td:" colSpan=3"}
			]},
			{row_style:"", cols:[
				
				{items:[{name:"#L.sysNo", 				type:"LABEL" , 	value:"測試API欄位：sysNo"}]},
				{items:[{name:"#F.sysNo", 				type:"TEXT", 	bind:"sysNo" }],td:" colSpan=7"}
			]}
		],
		beginService:"",
		closeService:""	
...
function functionInitial(){ 
	...
	table:"syle=border:3px #cccccc solid; cellpadding='1' border='1' width='100%'",
	title:"快捷鍵1",rows:[
			{row_style:"", cols:[
				{items:[
						{name:"#B.discount"      , type:"IMG"    ,value:"單筆折讓",   src:"./images/departmentPos/discount01.png", eClick:'doDiscount(2,"SINGEL","AUTO")'},
						{name:"#B.qty"      , type:"IMG"    ,value:"數量",   src:"./images/departmentPos/quantity.png", eClick:'detailModify("quantity",1)'},
						{name:"#B.cash"    , type:"IMG"    ,value:"現金",   src:"./images/departmentPos/cash.png", eClick:'payType("cash")'},
						{name:"#B.card"          , type:"IMG"    ,value:"信用卡",   src:"./images/departmentPos/card.png", eClick:'payType("card")'},
						{name:"#B.certificate"      , type:"IMG"    ,value:"禮券",   src:"./images/departmentPos/certificate.png", eClick:'payType("groupon")'},
						{name:"#B.currency"      , type:"IMG"    ,value:"匯率",   src:"./images/departmentPos/certificate.png", eClick:'openCurrencyList()'},
						{name:"#B.leave"      , type:"IMG"    ,value:"離開",   src:"./images/button_exit.gif", eClick:'closeWindows("CONFIRM")'},
						{name:"#B.void"      , type:"IMG"    ,value:"作廢",   src:"./images/button_void.gif", eClick:'executeVoidOrder()'}
				]}
			]},
			{row_style:"", cols:[
				{items:[
						{name:"#B.totalCount"      , type:"IMG"    ,value:"小計",   src:"./images/departmentPos/total.png", eClick:'executeTotalCountPage()'},
						{name:"#B.cancelTotal"      , type:"IMG"    ,value:"取消小記",   src:"./images/departmentPos/cancelTotal.png", eClick:'cancelTotalCountPage()'},
						{name:"#B.salesBtn"      , type:"IMG"    ,value:"結帳",   src:"./images/departmentPos/sales.png", eClick:'doSubmit("FINISH")'},
						{name:"#B.all_discount"      , type:"IMG"    ,value:"全部折扣",   src:"./images/departmentPos/all_discount.png", eClick:'doDiscount(1,"TOTAL","AUTO")'},
						{name:"#B.all_discount01"      , type:"IMG"    ,value:"全部折讓",   src:"./images/departmentPos/all_discount01.png", eClick:'doDiscount(2,"TOTAL","AUTO")'},
						{name:"#B.promotionFull"      , type:"IMG"    ,value:"滿額贈",   src:"./images/departmentPos/promotionFull.png", eClick:'openPromotionList()'},
						{name:"#B.appBtn"        , type:"IMG"    ,value:"17APP",   src:"./images/17app.png", eClick:'openAppCode()'}]}
...
function openPromotionList(){
	...
	var url = "/erp_dev_20210702/promotionList.jsp?headId=" + headId;
...
function openCurrencyList(){
	var url = "/erp_dev_20210702/currencyList.jsp";
	window.showModalDialog(url ,"匯率清單","dialogHeight:250px;dialogWidth:500px;dialogTop:100px;dialogLeft:100px;");
}
...
function totalInitial(){
    vat.block.create(vnB_Button, {
		id: "vatTotalDiv1",generate: true, table:"cellspacing='0' class='default' border='0' cellpadding='0'  height='100%'",	
			rows:[
			{row_style:"", cols:[
				{items:[{name:"#L.NTD_COUNT", 	type:"LABEL" , 	value:"台幣"}]},
				{items:[{name:"#F.NTD_COUNT", 	type:"TEXT" ,  mode:"READONLY" ,	bind:"NTD_COUNT", dec:0}]}
			
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.USD_COUNT", 	type:"LABEL" , 	value:"美金"}]},
				{items:[{name:"#F.USD_COUNT", 	type:"TEXT",  mode:"READONLY" ,	bind:"USD_COUNT", dec:0}]}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.JPY_COUNT", 	type:"LABEL" , 	value:"日幣"}]},
				{items:[{name:"#F.JPY_COUNT", 	type:"TEXT",  mode:"READONLY" ,	bind:"JPY_COUNT", dec:0}]}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.CNY_COUNT", 	type:"LABEL" , 	value:"人民幣"}]},
				{items:[{name:"#F.CNY_COUNT", 	type:"TEXT",  mode:"READONLY" ,	bind:"CNY_COUNT", dec:0}]}
			]}
...
/**小計**/
function totalInitial2(){
    vat.block.create(vnB_Button, {
		id: "vatTotalDiv2",generate: true, table:"cellspacing='0' class='default' border='0' cellpadding='0'  height='100%'",	
			rows:[
			...
			{row_style:"", cols:[
				...
				{items:[{name:"#F.balance", 	type:"TEXT" ,  mode:"READONLY" , dec:0}]}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.payment_cash", 	type:"LABEL" , 	value:"現金"}]},
				{items:[{name:"#F.payment_cash", 	type:"TEXT" ,  mode:"READONLY" ,dec:0,bind:"paymentCash"}]}
			...
			{row_style:"", cols:[
				{items:[{name:"#L.payment", 	type:"LABEL" , 	value:"第三方支付"}]},
				{items:[{name:"#F.payment", 	type:"TEXT",  mode:"READONLY" ,	bind:"paymentCard12", dec:0}]}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.paymentaaaaa", 	type:"LABEL" , 	value:"美金旅支"}]},
				{items:[{name:"#F.paymentaaaaa", 	type:"TEXT",  mode:"READONLY" ,	bind:"paymentCard13", dec:0}]}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.paymentxxxx", 	type:"LABEL" , 	value:"日幣旅支"}]},
				{items:[{name:"#F.paymentxxxx", 	type:"TEXT",  mode:"READONLY" ,	bind:"paymentCard14", dec:0}]}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.paymentcccc", 	type:"LABEL" , 	value:"歐元旅支"}]},
				{items:[{name:"#F.paymentcccc", 	type:"TEXT",  mode:"READONLY" ,	bind:"paymentCard15", dec:0}]}
			]}
...
/**查詢功能區**/
function totalInitial3(){
    vat.block.create(vnB_Button, {
		id: "vatTotalDiv3",generate: true, table:"cellspacing='0' class='default' border='0' cellpadding='0'  height='100%'",	
			rows:[
			{row_style:"", cols:[
				{items:[{name:"#L.payment_cashff", 	type:"LABEL" , 	value:"商品查詢"}]},
				{items:[{name:"#F.payment_cashvv", type:"IMG"    ,value:"17APP",   src:"./images/17app.png", eClick:'findItem()' }]}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.payment_cardbb", 	type:"LABEL" , 	value:"庫存查詢"}]},
				{items:[{name:"#F.payment_cardjj", type:"IMG"    ,value:"17APP",   src:"./images/17app.png", eClick:'openAppCode()'}]}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.payment_carduu", 	type:"LABEL" , 	value:"會員查詢"}]},
				{items:[{name:"#F.payment_cardtt",  type:"IMG"    ,value:"17APP",   src:"./images/17app.png", eClick:'findVIP()'}]}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.payment_cardhh", 	type:"LABEL" , 	value:"促銷查詢"}]},
				{items:[{name:"#F.payment_cardkk", type:"IMG"    ,value:"17APP",   src:"./images/17app.png", eClick:'openAppCode()'}]}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.payment_cardhh", 	type:"LABEL" , 	value:"匯率查詢"}]},
				{items:[{name:"#F.payment_cardkk", type:"IMG"    ,value:"17APP",   src:"./images/17app.png", eClick:'openAppCode()'}]}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.payment_cardhh", 	type:"LABEL" , 	value:"傳輸設定查詢"}]},
				{items:[{name:"#F.payment_cardkk", type:"IMG"    ,value:"17APP",   src:"./images/17app.png", eClick:'openAppCode()'}]}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.payment_cardhh", 	type:"LABEL" , 	value:"字軌設定查詢"}]},
				{items:[{name:"#F.payment_cardkk", type:"IMG"    ,value:"17APP",   src:"./images/17app.png", eClick:'openAppCode()'}]}
			]}
	 	 ],
			beginService:"",
...
function buttonLineTag(){
	...
	title:"", rows:[  
		{row_style:"", cols:[
			{items : [{name:"#B.011"      	, type:"IMG" , value:vPos_Comment["011"],  src:"./images/departmentPos/sale_off.png",  eClick:"functionLable('1')"},
					  {name:"#B.012"      	, type:"IMG" , value:vPos_Comment["012"],  src:"./images/departmentPos/sale_on.png",   eClick:"functionLable('1')"},
					  {name:"#B.021"      	, type:"IMG" , value:vPos_Comment["021"],  src:"./images/departmentPos/sale_off.png",  eClick:"functionLable('2')"},
					  {name:"#B.022"      	, type:"IMG" , value:vPos_Comment["022"],  src:"./images/departmentPos/sale_on.png",  eClick:"functionLable('2')"},
					  {name:"#B.031"      	, type:"IMG" , value:vPos_Comment["031"],  src:"./images/departmentPos/search_off.png",   eClick:"functionLable('3')"},
					  {name:"#B.032"      	, type:"IMG" , value:vPos_Comment["032"],  src:"./images/departmentPos/search_on.png",   eClick:"functionLable('3')"}]}	
		]}
		], 
		beginService:"",
		closeService:""				
...
function detailInitial(){
	...
	vat.item.make(vnB_Detail, "discount", 			        {type:"NUMM", size: 3, view: "", mode:"HIDDEN", maxLen: 8, desc:"折讓金額", dec:0});
	...
	vat.ajax.XHRequest(
    {
		...
		find: function checkItemCode(oXHR){
    		vat.item.setValueByName("#F.totalOriginalSalesAmount" , vat.ajax.getValue("totaleActualSalesAmount", oXHR.responseText)); 	
						...
						var ntd = vat.ajax.getValue("NTD_COUNT" , oXHR.responseText);
						vat.item.setValueByName("#F.NTD_COUNT",ntd);
						var cny = vat.ajax.getValue("CNY_COUNT" , oXHR.responseText);	
						vat.item.setValueByName("#F.CNY_COUNT",cny);
						var jpy = vat.ajax.getValue("JPY_COUNT" , oXHR.responseText);	
						vat.item.setValueByName("#F.JPY_COUNT",jpy);
						var usd = vat.ajax.getValue("USD_COUNT" , oXHR.responseText);	
						vat.item.setValueByName("#F.USD_COUNT",usd);	
    		if(changePage){
				insertNewItem();
			}
    	}   
