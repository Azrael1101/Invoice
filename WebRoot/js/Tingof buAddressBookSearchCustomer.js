...
vat.block.create( vnB_Header, {
	...
	title:"客戶資料查詢作業", rows:[  
	 	/*	{row_style:"", cols:[
			...
			{row_style:"", cols:[
				{items:[{name:"#L.customerTypeCode", 	type:"LABEL", 	value:"會員類型" }]},
			...
			{row_style:"", cols:[
				...
				{items:[{name:"#F.customerCode", 		type:"NUMM"}]},
				{items:[{name:"#L.chineseName", 		type:"LABEL", 	value:"會員姓名" }]},
				{items:[{name:"#F.chineseName", 		type:"TEXT"}]},
				{items:[{name:"#L.mobilePhone", 		    type:"LABEL", 	value:"會員電話" }]},
				{items:[{name:"#F.mobilePhone", 		    type:"NUMM"}]}	  		
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.address", 	        type:"LABEL", 	value:"住家地址" }]},
				{items:[{name:"#F.address", 	        type:"TEXT", size:30, maxLen:40}]},
				{items:[{name:"#L.directAddress", 		type:"LABEL", 	value:"宅配地址" }]},
				{items:[{name:"#F.directAddress", 		type:"TEXT", size:30, maxLen:40}], td:" colSpan=3"}]}	
...
function detailInitial(){
  ...
  var vbCanGridModify = true;
    ...
    vat.item.make(vnB_Detail, "customerCode"			, {type:"TEXT" , size:18, mode:"READONLY", desc:"會員代號"})
    vat.item.make(vnB_Detail, "chineseName"     		, {type:"TEXT" , size:10, mode:"READONLY", desc:"會員姓名"      });
    vat.item.make(vnB_Detail, "mobilPhone"    			, {type:"TEXT" , size:10, mode:"READONLY", desc:"電話"      });
   	vat.item.make(vnB_Detail, "vipTypeCode"     		, {type:"TEXT" , size:18, mode:"READONLY", desc:"會員類型"      });
    vat.item.make(vnB_Detail, "address"    		      	, {type:"TEXT" , size:10, mode:"READONLY", desc:"住家地址"      });
    vat.item.make(vnB_Detail, "directAddress"    		, {type:"TEXT" , size:10, mode:"READONLY", desc:"宅配地址"      });
