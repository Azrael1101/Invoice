...
function setDefaltValue(){
	...
	vat.item.setValueByName("#F.guiCode" , "DF12XOXOOOO");
...
function headerInitial(){ 
	...
	rows:[
			...
			{row_style:"", cols:[
				...
				{items:[{name:"#L.enterpriceCode", 					type:"LABEL" , 	value:"統編"}]},
				{items:[{name:"#F.enterpriceCode",		 			type:"TEXT",  mode:"READONLY" ,	bind:"enterpriceCode" }]},
...
function openCurrencyList(){
	...
	var url = "/erp_dev20201030/currencyList.jsp";
    ...
    vat.block.create(vnB_Button, {
		id: "vatTotalDiv1",generate: true, table:"cellspacing='0' class='default' border='0' cellpadding='0'  height='100%'",	
			...
			{row_style:"", cols:[
				...
				{items:[{name:"#F.NTD_COUNT", 	type:"TEXT" ,  mode:"READONLY" ,	bind:"paymentCash4", dec:0}]}
...
function totalInitial3(){
    vat.block.create(vnB_Button, {
		id: "vatTotalDiv3",generate: true, table:"cellspacing='0' class='default' border='0' cellpadding='0'  height='100%'",	
			rows:[
			{row_style:"", cols:[
				{items:[{name:"#L.payment_cashff", 	type:"LABEL" , 	value:"台幣2"}]},
				{items:[{name:"#F.payment_cashvv", 	type:"TEXT" ,  mode:"READONLY" ,	bind:"paymentCash111", dec:0}]}
			
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.payment_cardbb", 	type:"LABEL" , 	value:"美金"}]},
				{items:[{name:"#F.payment_cardjj", 	type:"TEXT",  mode:"READONLY" ,	bind:"paymentCard112", dec:0}]}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.payment_carduu", 	type:"LABEL" , 	value:"日幣"}]},
				{items:[{name:"#F.payment_cardtt", 	type:"TEXT",  mode:"READONLY" ,	bind:"paymentCard113", dec:0}]}
			]},
			{row_style:"", cols:[
				{items:[{name:"#L.payment_cardhh", 	type:"LABEL" , 	value:"人民幣"}]},
				{items:[{name:"#F.payment_cardkk", 	type:"TEXT",  mode:"READONLY" ,	bind:"paymentCard114", dec:0}]}
			]}
