	...
	if(typeof document.forms[0]["#loginBrandCode"] != 'undefined'){
        ...
        { 
	      ...
	      lastRecordNumber    	: 0
	   	...
	   	vat.bean.init(	
	  		function(){
					return "process_object_name=buGoalAchevementAction&process_object_method_name=performInitial"; 
	    	},{
	    		other: true
	    	}
	    );
	 ...
	 {row_style:"", cols:[
	 	{items:[{name:"#B.new"         , type:"IMG"    , value:"新增",  src:"./images/button_create.gif", eClick:"createNewForm()"},
	 			...
	 			{name:"#B.search"      , type:"PICKER" , value:"查詢",  src:"./images/button_find.gif"  , 
	 									 openMode:"open", 
	 									 service:"Bu_GOAL_ACHEVEMENT:search:20131017.page", 
...
function headerInitial(){ 
	vat.block.create( vnB_Header, { //vnB_Header = 
		...
		rows:[
			{row_style:"", cols:[
				{items:[{name:"#L.achevement", type:"LABEL", value:"達成率<font color='red'>*</font>"}]},
				{items:[{name:"#F.achevement", type:"NUMM", bind:"achevement", size:25, maxLen:25 }]}
			]},
			{row_style:"", cols:[
			...
			{row_style:"", cols:[
				{items:[{name:"#L.bonus", type:"LABEL" , value:"各達獎金<font color='red'>*</font>"}]},
				{items:[{name:"#F.bonus", type:"NUMM", bind:"bonus", size:25, maxLen:25 }]}
			]}
		], 	
...
function doSubmit(formAction){
	...
	if(confirm(alertMessage)){
		...
		vat.block.submit(function(){
				return "process_object_name=buGoalAchevementAction"+
