...
function kweImHeader(){ 
	...
	title:"系統功能查詢作業", rows:[  
			{row_style:"", cols:[
				{items:[{ name:"#L.functionCode", type:"LABEL", value:"功能代碼" }]},
				{items:[{ name:"#F.functionCode", type:"TEXT", bind:"functionCode",size:20 }] },
...
function kweImDetail(){
  ...
  var vbCanGridModify = true;
	...
	vat.item.make(vnB_Detail, "functionCode"         , {type:"TEXT" , size:15, maxLen:20, mode:"READONLY", desc:"功能代碼"      });
	vat.item.make(vnB_Detail, "functionName"       , {type:"TEXT" , size:18, maxLen:20, mode:"READONLY", desc:"功能名稱"      });
	vat.item.make(vnB_Detail, "functionCode"         , {type:"TEXT" , size:15, maxLen:20, mode:"HIDDEN"});
