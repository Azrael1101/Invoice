...
<link href='css/erp_pos.css' rel='stylesheet'>
</head>
<body><!-- vat JS files -->
...
<script type="text/javascript" src="js\soDepartmentOrderMain.js"></script>
<script type="text/javascript" src="js\soDepartmentOrderTool.js"></script>
