...
<%
	...
	SystemConfig.clearSystemConfigPro();
	boolean isProductionSystemMode = SystemConfig.isProductionSystemMode() ;
%>
...
<html>
  ...
  <body>
	Clean ERP PAGE Cache Finish [注意 : 如果要清除 Job 的CACHE 需要重新啟動 JOB MANAGER]... <br>
	開發模式 :<%=isProductionSystemMode%>
  </body>
</html>
