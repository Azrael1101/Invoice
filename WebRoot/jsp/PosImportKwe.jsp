...
<html>
	<head>
		...
		<script>
			...
			function T2PosImportHD(){
				if(confirm("是否匯入高雄機場銷售業績?")){
					$.blockUI({ message: '高雄機場銷售業績上傳中，請等待'});  
					importDataParse.T2PosImportHD('<%=employeeCode%>', function(callback){
						$.unblockUI();
						alert(callback);
					});
				}
	...
	<body>
		<form name="form0">
			<table>
				...
				<tr>
					<td>高雄匯入按此:</td>
					<td><img src="../images/button_import.gif" onClick="T2PosImportHD()"></td>
				</tr>
			</table>
		</form>
	</body>
